...
/*   Función que recibe el parametro del nombre del juego que el usuario desea buscar, la funcion verifica si en nuestro array se encuentra 
    ...
    if(juegoObtenido== undefined){
        ...
        Juego.innerHTML = '<p class="juego">  ' + juegoObtenido.nombre + ' <br> Descripción ' 
        + juegoObtenido.descripcion + ' <br> Genero:' + juegoObtenido.genero + ' <br> Plataforma: ' + juegoObtenido.plataforma
        '</p>';
